...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  // RiscV 128bits
  RELOC_NUMBER (R_RISCV_ADD128, 66)
  RELOC_NUMBER (R_RISCV_SUB128, 67)
  RELOC_NUMBER (R_RISCV_TLS_TPREL128, 68)
  RELOC_NUMBER (R_RISCV_TLS_DTPMOD128, 69)
  RELOC_NUMBER (R_RISCV_TLS_DTPREL128, 70)
  RELOC_NUMBER (R_RISCV_128, 71)
