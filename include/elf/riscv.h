...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  RELOC_NUMBER (R_RISCV_TLS_TPREL128, 12)
  RELOC_NUMBER (R_RISCV_TLS_DTPMOD128, 13)
  RELOC_NUMBER (R_RISCV_TLS_DTPREL128, 14)
  RELOC_NUMBER (R_RISCV_128, 15)
  ...
  RELOC_NUMBER (R_RISCV_ADD128, 59)
  RELOC_NUMBER (R_RISCV_SUB128, 60)
