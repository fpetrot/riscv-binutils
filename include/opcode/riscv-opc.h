...
#define MASK_SLLI_UW  0xf800707f
...
#define MASK_BCLRI  0xf800707f
#define MATCH_BSETI 0x28001013
#define MASK_BSETI  0xf800707f
#define MATCH_BINVI 0x68001013
#define MASK_BINVI  0xf800707f
#define MATCH_BEXTI 0x48005013
#define MASK_BEXTI  0xf800707f
...
#define MATCH_C_SUBD 0x9c41
#define MASK_C_SUBD  0xfc63
#define MATCH_C_ADDD 0x9c61
#define MASK_C_ADDD  0xfc63
...
#define MATCH_MULD 0x200007b
#define MASK_MULD  0xfe00707f
#define MATCH_DIVD 0x200407b
#define MASK_DIVD  0xfe00707f
#define MATCH_DIVUD 0x200507b
#define MASK_DIVUD  0xfe00707f
#define MATCH_REMD 0x200607b
#define MASK_REMD  0xfe00707f
#define MATCH_REMUD 0x200707b
#define MASK_REMUD  0xfe00707f
#define MATCH_AMOADD_Q 0x402f
#define MASK_AMOADD_Q  0xf800707f
#define MATCH_AMOXOR_Q 0x2000402f
#define MASK_AMOXOR_Q  0xf800707f
#define MATCH_AMOOR_Q 0x4000402f
#define MASK_AMOOR_Q  0xf800707f
#define MATCH_AMOAND_Q 0x6000402f
#define MASK_AMOAND_Q  0xf800707f
#define MATCH_AMOMIN_Q 0x8000402f
#define MASK_AMOMIN_Q  0xf800707f
#define MATCH_AMOMAX_Q 0xa000402f
#define MASK_AMOMAX_Q  0xf800707f
#define MATCH_AMOMINU_Q 0xc000402f
#define MASK_AMOMINU_Q  0xf800707f
#define MATCH_AMOMAXU_Q 0xe000402f
#define MASK_AMOMAXU_Q  0xf800707f
...
#define MATCH_ADD_UD 0x800103b
#define MASK_ADD_UD 0xfe00707f
#define MATCH_SH1ADD_UD 0x2000303b
#define MASK_SH1ADD_UD 0xfe00707f
#define MATCH_SH2ADD_UD 0x2000503b
#define MASK_SH2ADD_UD 0xfe00707f
#define MATCH_SH3ADD_UD 0x2000703b
#define MASK_SH3ADD_UD 0xfe00707f
#define MATCH_SLLI_UD 0x800201b
#define MASK_SLLI_UD 0xf800707f
...
DECLARE_INSN(c_addd, MATCH_C_ADDD, MASK_C_ADDD)
DECLARE_INSN(c_subd, MATCH_C_SUBD, MASK_C_SUBD)
DECLARE_INSN(slld, MATCH_SLLD, MASK_SLLD)
DECLARE_INSN(srld, MATCH_SRLD, MASK_SRLD)
DECLARE_INSN(srad, MATCH_SRAD, MASK_SRAD)
DECLARE_INSN(muld, MATCH_MULD, MASK_MULD)
DECLARE_INSN(divd, MATCH_DIVD, MASK_DIVD)
DECLARE_INSN(divud, MATCH_DIVUD, MASK_DIVUD)
DECLARE_INSN(remd, MATCH_REMD, MASK_REMD)
DECLARE_INSN(remud, MATCH_REMUD, MASK_REMUD)
DECLARE_INSN(amoadd_q, MATCH_AMOADD_Q, MASK_AMOADD_Q)
DECLARE_INSN(amoxor_q, MATCH_AMOXOR_Q, MASK_AMOXOR_Q)
DECLARE_INSN(amoor_q, MATCH_AMOOR_Q, MASK_AMOOR_Q)
DECLARE_INSN(amoand_q, MATCH_AMOAND_Q, MASK_AMOAND_Q)
DECLARE_INSN(amomin_q, MATCH_AMOMIN_Q, MASK_AMOMIN_Q)
DECLARE_INSN(amomax_q, MATCH_AMOMAX_Q, MASK_AMOMAX_Q)
DECLARE_INSN(amominu_q, MATCH_AMOMINU_Q, MASK_AMOMINU_Q)
DECLARE_INSN(amomaxu_q, MATCH_AMOMAXU_Q, MASK_AMOMAXU_Q)
...
DECLARE_INSN(add_ud, MATCH_ADD_UD, MASK_ADD_UD)
DECLARE_INSN(sh1add_ud, MATCH_SH1ADD_UD, MASK_SH1ADD_UD)
DECLARE_INSN(sh2add_ud, MATCH_SH2ADD_UD, MASK_SH2ADD_UD)
DECLARE_INSN(sh3add_ud, MATCH_SH3ADD_UD, MASK_SH3ADD_UD)
DECLARE_INSN(slli_ud, MATCH_SLLI_UD, MASK_SLLI_UD)
#endif /* DECLARE_INSN */
#ifdef DECLARE_CSR
