...
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX[ 	]+\*ABS\*
[ 	]+[0-9a-f]+:[ 	]+(00062603|00063603|0006260f)[ 	]+(lw|ld|lq)[ 	]+a2,0\(a2\).*
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_LO12_I[ 	]+\.L0[ ]+
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX[ 	]+\*ABS\*
[ 	]+[0-9a-f]+:[ 	]+00000697[ 	]+auipc[ 	]+a3,0x0
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_GOT_HI20[ 	]+a
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX[ 	]+\*ABS\*
[ 	]+[0-9a-f]+:[ 	]+(0006a683|0006b683|0006a68f)[ 	]+(lw|ld|lq)[ 	]+a3,0\(a3\).*
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_LO12_I[ 	]+\.L0[ ]+
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX[ 	]+\*ABS\*
...
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_GOT_HI20[ 	]+a
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX[ 	]+\*ABS\*
[ 	]+[0-9a-f]+:[ 	]+(0007a783|0007b783|0007a78f)[ 	]+(lw|ld|lq)[ 	]+a5,0\(a5\).*
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_PCREL_LO12_I[ 	]+\.L0[ ]+
[ 	]+[0-9a-f]+:[ 	]+R_RISCV_RELAX[ 	]+\*ABS\*
